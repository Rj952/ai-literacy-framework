...
export const POLICY_ALIGNMENTS: PolicyAlignment[] = [
  {
    ...
    year: '2025',
    connection: 'Direct foundation — the platform\'s five content areas and seven delivery principles are built upon and extend the DOL\'s national AI literacy framework for workforce readiness.',
  },
  {
  ...
  },
  {
    ...
    year: '2022',
    connection: 'Reinforces principles of safe and effective systems, algorithmic discrimination protections, data privacy, notice and explanation, and human alternatives — all reflected in the framework\'s responsible use content.',
  },
  {
    policy: 'Workforce Innovation and Opportunity Act (WIOA)',
    source: 'U.S. Department of Labor',
    year: '2014/Reauthorized',
    connection: 'Supports WIOA\'s emphasis on workforce training, digital literacy, and career pathway development — the platform enables organizations to build AI-specific learning pathways aligned with WIOA goals.',
  },
  {
